...
+ We will discuss a basic example of web scraping where we extract latest stories from a news website (Times of India, Guwahati Page). We extract only the headlines. Everything you see on the web can be extracted. Refer to [Beautiful soup]((https://www.crummy.com/software/BeautifulSoup/bs4/doc/)) documentation for more details.
